...
world: RK3588 RK3566 RK3326 RK3399 S922X SM8250 QCS6490 SM8550 H700 SM8650
...
QCS6490:
	unset DEVICE_ROOT
	PROJECT=ROCKNIX DEVICE=QCS6490 ARCH=arm ./scripts/build_distro
	PROJECT=ROCKNIX DEVICE=QCS6490 ARCH=aarch64 ./scripts/build_distro
